...
adapter_dir = repo / 'distilled_model_05b' / 'final'
out_dir = repo / 'distilled_model_merged_05b_vllm'

cfg = json.loads((adapter_dir / 'adapter_config.json').read_text())
base_model_name = cfg.get('base_model_name_or_path', 'Qwen/Qwen2.5-0.5B')
